...
const SLOT_CONFIG = {
  ...
  symbols: [
    ...
    { id: "blue", label: "◆", name: "Сапфир", tier: "low", weight: 12.8, color: "#66b8ff", icon: "./assets/pharaoh-icons-lite/blue-gem.webp" },
    { id: "green", label: "◆", name: "Изумруд", tier: "low", weight: 13.2, color: "#8dff9d", icon: "./assets/pharaoh-icons-lite/green-gem.webp" },
    { id: "scatter", label: "☀", name: "Дар джина", tier: "scatter", weight: 0.85, color: "#f4ccff", icon: "./assets/pharaoh-icons-lite/genie-scatter-v1.png" },
...
const STARTUP_ASSETS = [
  ...
  "./assets/pharaoh-icons-lite/genie-scatter-v1.png",
...
const SLOT_WIN_TREASURE_PARTICLES = {
  coin: "./assets/pharaoh-icons-lite/coin.webp",
  ruby: "./assets/pharaoh-icons-lite/ruby.webp",
  blueGem: "./assets/pharaoh-icons-lite/blue-gem.webp",
  greenGem: "./assets/pharaoh-icons-lite/green-gem.webp",
  scarab: "./assets/pharaoh-icons-lite/scarab.webp",
  sun: "./assets/pharaoh-icons-lite/genie-scatter-v1.png",
  scroll: "./assets/pharaoh-icons-lite/scroll.webp",
  ankh: "./assets/pharaoh-icons-lite/ankh.webp",
  orb: "./assets/pharaoh-icons-lite/multiplier-orb.webp",
};
