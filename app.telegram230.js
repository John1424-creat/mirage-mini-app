...
function getCarpetPointOnPath(progress) {
  ...
  if (!geometry) {
    return { x: 184 * progress, y: -226 * progress, rotate: -8 + progress * 12 };
  }
  ...
  return {
    x: point.x - geometry.startPoint.x,
    y: point.y - geometry.startPoint.y,
    rotate: -12 + headingProgress * 16,
  };
}
