...
const SLOT_GENIE_REACTION_ASSETS = {
  idle: "./assets/pharaoh-icons/genie-state-idle-clean.webp",
  casting: "./assets/pharaoh-icons/genie-state-spin-clean.webp",
  spin: "./assets/pharaoh-icons/genie-state-spin-clean.webp",
  cascade: "./assets/pharaoh-icons/genie-state-cascade-clean.webp",
  win: "./assets/pharaoh-icons/genie-state-win-clean.webp",
  big: "./assets/pharaoh-icons/genie-state-legend-clean.webp",
  mega: "./assets/pharaoh-icons/genie-state-legend-clean.webp",
  legend: "./assets/pharaoh-icons/genie-state-legend-clean.webp",
  free: "./assets/pharaoh-icons/genie-state-cascade-clean.webp",
};
...
function getSlotReactionContent(slot) {
  ...
  if (slot.status !== "READY") {
    ...
    return { state: "casting", text: "МАГИЯ СПИНА" };
  }
  if (slot.totalWin > 0) {
  ...
  if (slot.autoRunning || slot.autoRunsRemaining > 0) return { state: "casting", text: "АВТО СПИН" };
...
function positionSlotPresentationPanel(panel) {
  ...
  const width = Math.min(gridRect.width - 28, viewportWidth - 70, 318);
...
function startSlotWinCeremony(type, amount, preferredDuration = 3000) {
  ...
  const draw = (now) => {
    ...
    if (alpha > 0) {
      const washRadius = Math.max(width, height) * 0.92;
      const wash = ctx.createRadialGradient(width * 0.5, height * 0.36, 0, width * 0.5, height * 0.36, washRadius);
      wash.addColorStop(0, `rgba(255, 224, 122, ${0.09 * alpha})`);
      wash.addColorStop(0.42, `rgba(255, 172, 71, ${0.035 * alpha})`);
      wash.addColorStop(0.7, `rgba(92, 43, 112, ${0.018 * alpha})`);
