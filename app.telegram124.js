...
const SLOT_CONFIG = {
  ...
  symbols: [
    { id: "pharaoh", label: "♛", name: "Фараон", tier: "high", weight: 4.4, color: "#ffd97a", icon: "./assets/pharaoh-icons/pharaoh-mask.png" },
    { id: "lamp", label: "✦", name: "Лампа", tier: "high", weight: 5.2, color: "#ffb44d", icon: "./assets/pharaoh-icons/genie-lamp.png" },
    { id: "ruby", label: "◆", name: "Рубин", tier: "high", weight: 6.4, color: "#ff4fb3", icon: "./assets/pharaoh-icons/ruby.png" },
    { id: "scarab", label: "✹", name: "Скарабей", tier: "mid", weight: 8.2, color: "#62dfb4", icon: "./assets/pharaoh-icons/scarab.png" },
    { id: "scroll", label: "▰", name: "Свиток", tier: "mid", weight: 9.4, color: "#f7cf72", icon: "./assets/pharaoh-icons/scroll.png" },
    { id: "ankh", label: "☥", name: "Анкх", tier: "mid", weight: 10.2, color: "#d7a8ff", icon: "./assets/pharaoh-icons/ankh.png" },
    { id: "coin", label: "●", name: "Монета", tier: "low", weight: 12.5, color: "#ffdc75", icon: "./assets/pharaoh-icons/coin.png" },
    { id: "blue", label: "◆", name: "Синий камень", tier: "low", weight: 12.8, color: "#66b8ff", icon: "./assets/pharaoh-icons/blue-gem.png" },
    { id: "green", label: "◆", name: "Зеленый камень", tier: "low", weight: 13.2, color: "#8dff9d", icon: "./assets/pharaoh-icons/green-gem.png" },
    { id: "scatter", label: "☀", name: "Scatter", tier: "scatter", weight: 1.05, color: "#fff0a6", icon: "./assets/pharaoh-icons/sun-scatter.png" },
    { id: "multi", label: "×", name: "Множитель", tier: "multi", weight: 0.55, color: "#ff73d5", icon: "./assets/pharaoh-icons/multiplier-orb.png" },
  ],
  payouts: {
...
const STARTUP_ASSETS = [
  ...
  "./assets/pharaoh-icons/pharaoh-mask.png",
  "./assets/pharaoh-icons/genie-lamp.png",
  "./assets/pharaoh-icons/ruby.png",
  "./assets/pharaoh-icons/scarab.png",
  "./assets/pharaoh-icons/scroll.png",
  "./assets/pharaoh-icons/ankh.png",
  "./assets/pharaoh-icons/coin.png",
  "./assets/pharaoh-icons/blue-gem.png",
  "./assets/pharaoh-icons/green-gem.png",
  "./assets/pharaoh-icons/sun-scatter.png",
  "./assets/pharaoh-icons/multiplier-orb.png",
  ...
  if (gridRoot) {
    ...
    visibleGrid.forEach((row, rowIndex) => {
      row.forEach((symbolId, colIndex) => {
        ...
        cell.className = `slot-symbol ${symbol.tier}`;
        if (slot.winningKeys?.has(`${rowIndex}-${colIndex}`)) cell.classList.add("winning");
...
async function playPharaohSlot({ bonusBuy = false, autoStep = false } = {}) {
  ...
  try {
    ...
    for (let previewIndex = 0; previewIndex < 5; previewIndex += 1) {
      await sleep(82 + previewIndex * 18);
    ...
    for (const [index, step] of result.steps.entries()) {
      ...
      renderPharaoh();
      await sleep(step.wins.length > 0 ? 620 : 360);
    }
