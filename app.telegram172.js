...
const STARTUP_ASSETS = [
  ...
  "./assets/pharaoh-icons/genie-state-idle.webp",
  "./assets/pharaoh-icons/genie-state-spin.webp",
  "./assets/pharaoh-icons/genie-state-cascade.webp",
  "./assets/pharaoh-icons/genie-state-win.webp",
  "./assets/pharaoh-icons/genie-state-legend.webp",
];
const STARTUP_MIN_VISIBLE_MS = 900;
const STARTUP_MAX_WAIT_MS = 5200;

const SLOT_GENIE_REACTION_ASSETS = {
  idle: "./assets/pharaoh-icons/genie-state-idle.webp",
  casting: "./assets/pharaoh-icons/genie-state-idle.webp",
  spin: "./assets/pharaoh-icons/genie-state-spin.webp",
  cascade: "./assets/pharaoh-icons/genie-state-cascade.webp",
  win: "./assets/pharaoh-icons/genie-state-win.webp",
  big: "./assets/pharaoh-icons/genie-state-legend.webp",
  mega: "./assets/pharaoh-icons/genie-state-legend.webp",
  legend: "./assets/pharaoh-icons/genie-state-legend.webp",
  free: "./assets/pharaoh-icons/genie-state-cascade.webp",
};
