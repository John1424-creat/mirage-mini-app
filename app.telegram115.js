...
const SLOT_CONFIG = {
  ...
  symbols: [
    { id: "pharaoh", label: "Ф", name: "Фараон", tier: "high", weight: 4.4, color: "#ffd97a" },
    { id: "lamp", label: "Л", name: "Лампа", tier: "high", weight: 5.2, color: "#ffb44d" },
    { id: "ruby", label: "R", name: "Рубин", tier: "high", weight: 6.4, color: "#ff4fb3" },
    { id: "scarab", label: "S", name: "Скарабей", tier: "mid", weight: 8.2, color: "#62dfb4" },
    { id: "scroll", label: "С", name: "Свиток", tier: "mid", weight: 9.4, color: "#f7cf72" },
    { id: "ankh", label: "A", name: "Анкх", tier: "mid", weight: 10.2, color: "#d7a8ff" },
    { id: "coin", label: "C", name: "Монета", tier: "low", weight: 12.5, color: "#ffdc75" },
    { id: "blue", label: "B", name: "Синий камень", tier: "low", weight: 12.8, color: "#66b8ff" },
    { id: "green", label: "G", name: "Зеленый камень", tier: "low", weight: 13.2, color: "#8dff9d" },
    { id: "scatter", label: "☀", name: "Scatter", tier: "scatter", weight: 1.05, color: "#fff0a6" },
    { id: "multi", label: "×", name: "Множитель", tier: "multi", weight: 0.55, color: "#ff73d5" },
  ],
  payouts: {
...
function renderSlotPaytable() {
  ...
  special.innerHTML = `
    ...
    <span><b>Bonus buy</b> подготовлен, но выключен до отдельной RTP-проверки.</span>
  `;
...
function renderPharaoh() {
  ...
  if (bonus) {
    bonus.disabled = !SLOT_CONFIG.bonusBuy.enabled || slot.status !== "READY";
...
function initEvents() {
  ...
  if (slotBonusBuy) {
    slotBonusBuy.addEventListener("click", () => playPharaohSlot({ bonusBuy: true }));
  }
