...
const SLOT_CONFIG = {
  ...
  symbols: [
    { id: "pharaoh", label: "♛", name: "Фараон", tier: "high", weight: 4.4, color: "#ffd97a" },
    { id: "lamp", label: "✦", name: "Лампа", tier: "high", weight: 5.2, color: "#ffb44d" },
    { id: "ruby", label: "◆", name: "Рубин", tier: "high", weight: 6.4, color: "#ff4fb3" },
    { id: "scarab", label: "✹", name: "Скарабей", tier: "mid", weight: 8.2, color: "#62dfb4" },
    { id: "scroll", label: "▰", name: "Свиток", tier: "mid", weight: 9.4, color: "#f7cf72" },
    { id: "ankh", label: "☥", name: "Анкх", tier: "mid", weight: 10.2, color: "#d7a8ff" },
    { id: "coin", label: "●", name: "Монета", tier: "low", weight: 12.5, color: "#ffdc75" },
    { id: "blue", label: "◆", name: "Синий камень", tier: "low", weight: 12.8, color: "#66b8ff" },
    { id: "green", label: "◆", name: "Зеленый камень", tier: "low", weight: 13.2, color: "#8dff9d" },
