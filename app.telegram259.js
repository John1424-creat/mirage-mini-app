...
function getSlotBonusBuyLimit() {
  return Math.floor(SLOT_CONFIG.roomPoolUsd * SLOT_CONFIG.bonusBuy.maxPoolShare);
}
...
homeMonkeyImages.left.src = "./assets/plinko-monkey-guardian-v2.webp?v=telegram259";
homeMonkeyImages.right.src = "./assets/plinko-monkey-guardian-v2.webp?v=telegram259";
